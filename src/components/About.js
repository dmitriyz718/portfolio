  ...
  render() {
    return (
      <div id="about">
        ...
        <p>
          Originaly started off studying computer science at WKU dual majoring
        ...
        <p>
          ...
          products on Amazon, Wayfair, and so on. I kept this role for quite a
          while, doing what I can to improve business and client interactions
          with their websites, however I did not feel challenged, which
          eventually led me to begin my journey at General Assembly in the
          Software Engineering Immersive. Having graduated with a 100%
          completion rate, I feel my addition to any team would greatly benefit
          any entity both from my technical expertise as well as creativity
        </p>
        ...
        <p>
          ...
          it produces. My passion is the development of web applications that
          are easy to use and better the users experience.
        </p>
      </div>
    );
  }
